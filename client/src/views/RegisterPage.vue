            ...
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" @submit.prevent="register">
                  ...
                  <p class="text-center text-white text-muted mt-2 mb-0">Have already an account? <router-link to="/login" class="fw-bold text-danger"><u>Login here</u></router-link></p>
                </form>
